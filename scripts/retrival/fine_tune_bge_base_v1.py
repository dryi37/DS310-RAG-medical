...
class TripletSampleDataset(Dataset):
    ...
    Returns InputExample(texts=[q, pos, neg])
    """
    ...
    def __getitem__(self, idx):
        ...
        return InputExample(texts=[it["q"], it["pos"], neg])
...
def evaluate_retriever(model, val_data, ks=(1, 5, 10), batch_size=32):
    ...
    # Cosine similarity via normalize + dot
...
def main():
    parser = argparse.ArgumentParser(description="Fine-tune bge-base-en-v1.5 with TripletLoss (sample negatives)")
    ...
    parser.add_argument("--out", type=str, default="bge-base-en-v1.5-triplet-sample")
