...
#     # Map answer text -> list of indices
...
# def main():
#     parser = argparse.ArgumentParser(description="Fine-tune Qwen3 embedding retriever")
#     parser.add_argument("--train", type=str, required=True)
#     parser.add_argument("--val", type=str, required=True)

#     parser.add_argument("--model", type=str, default="Qwen/Qwen3-Embedding-0.6B")

#     parser.add_argument("--out", type=str, default="qwen3-embedding-0.6B-finetuned")
